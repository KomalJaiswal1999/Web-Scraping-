...
class htmlhelper:
    ...
    def mainlinksinsert(id: str,date: str, zip: str, mainlink: str,cat1: str, cat2: str, cat3: str, cat4: str, cat5: str, iscomplete: str, totalcount: str, extra1: str, extra2: str,extra3: str):
        return {"id":id,"date":date,"zip":zip,"mainlink":mainlink,"cat1":cat1,"cat2":cat2,"cat3":cat3,"cat4":cat4,"cat5":cat5,"iscomplete":iscomplete,"totalcount":totalcount,"extra1":extra1,"extra2":extra2,"extra3":extra3}

    def addheader(filepath:str):
        return "ID|SITE|ZIP|DATE|IMAGELINK|PRICE|PRICE_MULT|EPRICE|EINDICATOR|ALTPRICE|ALTPRICEMULT|EALTPRICE|ALTINDICATOR|PACK|UNIT|UOM|SIZE|PRODUCT_ID|UPC|ASIN|CATEGORY|DESCRIPTION|NOTE|RATING|VALID|PAGEIMAGE|AISLE|ORIG_UPC|JOB_NUMBER|SALE_ENDDATE\n"

    @staticmethod
    def createpsv(id:str,site: str, zip: str, date: str, Imagelink: str, price: str, price_mult: str, Eprice: str,
    ...
    def insert_data(tablename, data):
        ...
        if DBConfig.SQlServer == "CloudDevlopment":
            conn = pyodbc.connect(
                "Driver={SQL SERVER};"
